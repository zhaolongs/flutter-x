...
class SwiperViewDotPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return new SwiperViewDotPageState();
  }
}

class SwiperViewDotPageState extends BaseAppBarPageState<StatefulWidget> {
  @override
