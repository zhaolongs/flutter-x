...
import com.al.flutter_x.utils.WebviewSetingUtils;
...
public class ComplexWebView implements PlatformView, MethodChannel.MethodCallHandler {
	...
	ComplexWebView(Context context, BinaryMessenger messenger, int id, Map<String, Object> params) {
...
//
	...
	public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
		...
		//设置result
		mWebviewSetingUtils.setResult(result);
		...
		if (lMethod.equals("load")) {
			...
			} else if (params != null && params.containsKey("datablock")) {
				//加载html文件数据
				String artContent = (String) params.get("datablock");
				//加载html 代码块
				//在这里构造一个完整的html
