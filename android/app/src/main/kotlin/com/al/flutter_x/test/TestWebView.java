...
public class TestWebView implements PlatformView, MethodChannel.MethodCallHandler {
	...
	TestWebView(Context context, BinaryMessenger messenger, int id, Map<String, Object> params) {
		mContext = context;
		...
		} else if (params.containsKey("datablock")) {
			//加载html文件数据
